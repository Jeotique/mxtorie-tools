...
module.exports = {
    name: 'welcome_delete_after',
    description: "Définie après combien de temps le message de bienvenue ce supprime.",
    type: "CHAT_INPUT",
    options: [{
        name: 'type',
    ...
    run: async(client, interaction)=>{
        ...
        if(askedTime.toLowerCase()==="off"){
            switch(type){
                case 'know_invite': client.db.delete(`welcome_deleteafter_${interaction.guildId}`); break;
                case 'vanity': client.db.delete(`welcomevanity_deleteafter_${interaction.guildId}`); break;
                case 'unknow': client.db.delete(`welcomeunknow_deleteafter_${interaction.guildId}`); break;
                case 'himself': client.db.delete(`welcomehimself_deleteafter_${interaction.guildId}`); break;
            }
            ...
            switch(type){
                case 'know_invite': client.db.set(`welcome_deleteafter_${interaction.guildId}`, time); break;
                case 'vanity': client.db.set(`welcomevanity_deleteafter_${interaction.guildId}`, time); break;
                case 'unknow': client.db.set(`welcomeunknow_deleteafter_${interaction.guildId}`, time); break;
                case 'himself': client.db.set(`welcomehimself_deleteafter_${interaction.guildId}`, time); break;
            }
