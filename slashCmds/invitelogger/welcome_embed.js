...
module.exports = {
    name: 'welcome_embed',
    description: "Assigne un embed au message de bienvenue, pour cela le bot se base sur un embed déjà existant.",
    type: "CHAT_INPUT",
    options: [{
        name: 'type',
    ...
    run: async(client, interaction)=>{
        ...
        for(emb of msg.embeds){
            ...
            switch(type){
                case 'know_invite': client.db.set(`welcomeembed_${interaction.guildId}`, emb); break;
                case 'vanity': client.db.set(`welcomeembedvanity_${interaction.guildId}`, emb); break;
                case 'unknow': client.db.set(`welcomeembedunknow_${interaction.guildId}`, emb); break;
                case 'himself': client.db.set(`welcomeembedhimself_${interaction.guildId}`, emb); break;
            }
