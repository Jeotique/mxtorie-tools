...
module.exports = {
    ...
    run: async(client, interaction)=>{
        ...
        switch(type){
            case 'know_invite': client.db.set(`welcome_isembed_${interaction.guildId}`, isEmbed); break;
            case 'vanity': client.db.set(`welcomevanity_isembed_${interaction.guildId}`, isEmbed); break;
            case 'unknow': client.db.set(`welcomeunknow_isembed_${interaction.guildId}`, isEmbed); break;
            case 'himself': client.db.set(`welcomehimself_isembed_${interaction.guildId}`, isEmbed); break;
        }
